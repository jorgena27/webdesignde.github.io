<?php
$themename = "Screen Theme";
$shortname = "pixel_theme";
$settings_list = array(
    'custom_logo_url',
    'featured_text',
...
<tr>
  ...
  <td><input type="text" name="custom_logo_url" class="ss_text" value="<?php echo stripslashes(stripslashes(get_option($shortname.'_custom_logo_url',''))); ?>" /><br /><small><a href="<?php bloginfo('url'); ?>/wp-admin/media-new.php" target="_blank">Upload your logo</a> (ex:120px wide x 50px high)</small></td>
</tr>
...
<tr>
  <td>Featured Text:</td>
  <td><textarea name="featured_text" style="width: 550px; height: 150px;"><?php echo stripslashes(stripslashes(get_option($shortname.'_featured_text',''))); ?></textarea></td>
</tr>
